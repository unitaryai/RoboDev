...
const createTicketsStateIdx = `CREATE INDEX IF NOT EXISTS idx_tickets_state_created_at ON tickets(state, created_at, id)`
const createCommentsTicketIdx = `CREATE INDEX IF NOT EXISTS idx_ticket_comments_ticket_created_at ON ticket_comments(ticket_id, created_at, id)`
const createEventsTicketIdx = `CREATE INDEX IF NOT EXISTS idx_ticket_events_ticket_created_at ON ticket_events(ticket_id, created_at, id)`
