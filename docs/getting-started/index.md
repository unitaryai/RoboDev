...
-   :material-docker:{ .lg .middle } **Try it locally first**
...
-   :material-kubernetes:{ .lg .middle } **Deploy to Kubernetes**
...
-   :material-github:{ .lg .middle } **GitHub Issues + Slack**
...
-   :material-lightning-bolt:{ .lg .middle } **Shortcut + Slack**
